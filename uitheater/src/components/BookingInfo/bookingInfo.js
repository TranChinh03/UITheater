    ...
    <>
      <div className='container'>
        ...
        <div className='info-container'>
          ...
          <div className='info'>
            <div className='info1'>
              <div className='infofo' style={{ width: '230px', backgroundColor: 'white' }}>
                <div className='info-title'>Showtime:</div>
                <div className='info-data'>13:00</div>
              </div>
              <div className='infofo' style={{ width: '330px', backgroundColor: 'purple' }}>
                <div className='info-title'>Date:</div>
                <div className='info-data'>31 - 02 - 2023</div>
              </div>
              <div className='infofo' style={{ width: '250px', backgroundColor: 'blue' }}>
                <div className='info-title'>Ticket:</div>
                <div className='info-data'>2 tickets</div>
              </div>
              <div className='infofo' style={{ width: '450px', backgroundColor: 'pink' }}>
                <div className='info-title'>Total:</div>
                <div className='info-data'>200.000 vnd</div>
              </div>
            </div>
            <div className='info2'>
              <div style={{ width: '200px', backgroundColor: 'yellow' }}>Seat number:</div>
              <div></div>
            </div>
          </div>
        </div>
